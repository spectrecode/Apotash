...
for($i=0;$i<=$count;$i++){
  ...
  $not_descripcion = $objfunc->convertir_html(substr($data['not_descripcion'], 0, 150));
    ...
    <header class="header" ng-controller="headerCrtl">
      <div class="container">
        <div class="logo-max hidden-md hidden-lg">
          <a href="<?php echo _URL_?>index"><img src="./resources/assets/image/logo-trans.png" id="logo-apM" alt="" width="100%"/></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 visible-md visible-lg-inline-block">
            <div class="box-search" id="box-search">
              <div><a class="active" href="<?php echo _URL_?>index">Español</a><span> /</span><a href="<?php echo _URL_?>en/index">English</a></div><img src="./resources/assets/image/lupa.png" width="40px" alt=""/>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="container-prensa">
                    ...
                    <div class="row text-center hidden-xs hidden-sm"><a href="<?php echo _URL_?>detalle">Ver más</a></div>
                  </div>
                </div>
              </div>
            </div>
