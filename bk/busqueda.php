        ...
        <div class="row">
          ...
          <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 visible-md visible-lg-inline-block">
            <div class="box-search" id="box-search">
              <div><a class="active" href="http://americas-potash.com/demoV5/index.html">Español</a><span> /</span><a href="./en/index.html">English</a></div><img src="./resources/assets/image/lupa.png" width="40px" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container-fluid">
          <div class="row hidden-md hidden-lg">
            <nav class="menu-collapse">
              <ul class="menu-collapse text-center"><a href="http://americas-potash.com/demoV5/index.html">
                  <li>Inicio</li></a><a href="http://americas-potash.com/demoV5/nosotros.html">
                  <li>Nosotros</li></a><a href="http://americas-potash.com/demoV5/fosfatos.html">
                  <li>Proyectos</li></a><a href="http://americas-potash.com/demoV5/sostenibilidad.html">
                  <li>Sostenibilidad</li></a><a href="http://americas-potash.com/demoV5/comunicacion-corporativa.html">
                  <li>Comunicación Corporativa</li></a><a href="http://americas-potash.com/demoV5/contacto.html">
                  <li>Contáctenos</li></a>
                <ul class="idiomas"><a href="#">
                    <li class="activeIdioma">Español</li></a><a href="#">
                    <li>English</li></a></ul>
              </ul>
            </nav>
          </div>
          <input class="style-box-search disp-none" type="text" id="busqueda" name="search" placeholder="Buscar..." autofocus>
        </div>
      </div>
    </header>
