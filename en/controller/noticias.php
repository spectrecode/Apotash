...
if ($arr['paginacion'] == 1){
	...
	$arr['noticias'].= "<div class='inner-logo'><a href='Detail.html'><img src='./resources/assets/image/comunicacion-corporativa/5690.png' alt=''></a></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>";
	$arr['noticias'].= "<a href='Detail.html'><h4>AMERICAS POTASH BECA DOCENTE (Teacher´s Scholarship) PROGRAM STARTED</h4></a>";
	...
	$arr['noticias'].= "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right'><a href='Detail.html'>Read more</a><img src='./resources/assets/image/comunicacion-corporativa/arrow-right.png' alt=''></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	...
	$arr['noticias'].= "<div class='row inner-noticia'>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12 inner-img'>";
	$arr['noticias'].= "<div class='inner-logo'><a href='Detail-1.html'><img src='./resources/assets/image/comunicacion-corporativa/1063.png' alt=''></a></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>";
	$arr['noticias'].= "<a href='Detail-1.html'><h4>GROWMAX IS PLEASED TO PROVIDE GUIDANCE REGARDING THE COMPANY'S LONG-TERM DEVELOPMENT STRATEGY.</h4></a>";
	...
	$arr['noticias'].= "<div class='seguirL'>";
	$arr['noticias'].= "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right'><a href='Detail-1.html'>Read more</a><img src='./resources/assets/image/comunicacion-corporativa/arrow-right.png' alt=''></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	...
	$arr['noticias'].= "<div class='row inner-noticia'>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12 inner-img'>";
	$arr['noticias'].= "<div class='inner-logo'><a href='Detail-2.html'><img src='./resources/assets/image/comunicacion-corporativa/brochure2.jpg' alt=''></a></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>";
	$arr['noticias'].= "<a href='Detail-2.html'><h4>US$ 10 MILLION WILL BE INVESTED</h4></a>";
	...
	$arr['noticias'].= "<div class='seguirL'>";
	$arr['noticias'].= "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right'><a href='Detail-2.html'>Read more</a><img src='./resources/assets/image/comunicacion-corporativa/arrow-right.png' alt=''></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
}
...
if ($arr['paginacion'] == 2){
	...
	$arr['noticias'].= "<div class='seguirL'>";
	$arr['noticias'].= "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right'><a href='detalle.html'>Read more</a><img src='./resources/assets/image/comunicacion-corporativa/arrow-right.png' alt=''></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
