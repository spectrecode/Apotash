...
if ($arr['paginacion'] == 1){
	...
	$arr['noticias'].= "<div class='inner-logo'><a href='http://americas-potash.com/en/americas-potash-beca-docente-program-started'><img src='./resources/assets/image/comunicacion-corporativa/5690.png' alt=''></a></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>";
	$arr['noticias'].= "<a href='http://americas-potash.com/en/americas-potash-beca-docente-program-started'><h4>AMERICAS POTASH BECA DOCENTE (Teacher´s Scholarship) PROGRAM STARTED</h4></a>";
	...
	$arr['noticias'].= "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right'><a href='http://americas-potash.com/en/americas-potash-beca-docente-program-started'>Read more</a><img src='./resources/assets/image/comunicacion-corporativa/arrow-right.png' alt=''></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	//************************************
	$arr['noticias'].= "<div class='row inner-noticia'>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12 inner-img'>";
	$arr['noticias'].= "<div class='inner-logo'><a href='http://americas-potash.com/en/growmax-is-pleased-to-provide-guidance-regarding-the-companys-long-term-development-strategy'><img src='./resources/assets/image/comunicacion-corporativa/1063.png' alt=''></a></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>";
	$arr['noticias'].= "<a href='http://americas-potash.com/en/growmax-is-pleased-to-provide-guidance-regarding-the-companys-long-term-development-strategy'><h4>GROWMAX IS PLEASED TO PROVIDE GUIDANCE REGARDING THE COMPANY'S LONG-TERM DEVELOPMENT STRATEGY.</h4></a>";
	...
	$arr['noticias'].= "<div class='seguirL'>";
	$arr['noticias'].= "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right'><a href='http://americas-potash.com/en/growmax-is-pleased-to-provide-guidance-regarding-the-companys-long-term-development-strategy'>Read more</a><img src='./resources/assets/image/comunicacion-corporativa/arrow-right.png' alt=''></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	//************************************
	$arr['noticias'].= "<div class='row inner-noticia'>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12 inner-img'>";
	$arr['noticias'].= "<div class='inner-logo'><a href='10-million-will-be-invested'><img src='./resources/assets/image/comunicacion-corporativa/brochure2.jpg' alt=''></a></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "<div class='col-lg-6 col-md-6 col-sm-6 col-xs-12'>";
	$arr['noticias'].= "<a href='10-million-will-be-invested'><h4>US$ 10 MILLION WILL BE INVESTED</h4></a>";
	...
	$arr['noticias'].= "<div class='seguirL'>";
	$arr['noticias'].= "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right'><a href='10-million-will-be-invested'>Read more</a><img src='./resources/assets/image/comunicacion-corporativa/arrow-right.png' alt=''></div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
	$arr['noticias'].= "</div>";
}
