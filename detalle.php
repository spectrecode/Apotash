...
for($i=0;$i<=$item;$i++){
    ...
    $html_gal.= "<li class='example-group' data-fancybox='group' href='"._URL_."/admin-americas/resources/assets/image/noticias/galeria/".$gal_imagen."'>";
    $html_gal.= "<img class='image-click' src='"._URL_."/admin-americas/resources/assets/image/noticias/galeria/".$gal_imagen."' alt='' width='100%'>";
