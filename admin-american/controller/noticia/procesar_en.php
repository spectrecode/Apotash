...
$arrjson['ruta'] = "../../resources/assets/image/noticias/";
...
$arrjson['ruta_gal'] = "../../resources/assets/image/noticias/galeria/";
...
if ($arrjson['codigo'] > 0){
	...
	$bool_sql 	= $objnot->hacerActualizacion_en($arrjson);
	$objnot 	= new Noticia();
	$arrjson['sql_seo'] = $objnot->actualizarUrlSeo_en($arrjson);
	$arrjson['galeria'] = "";
	if (isset($_FILES['galeria']))
		if (!empty($_FILES['galeria'])){
			$arrjson['galeria'] = $objfunc->subirFoto('galeria',$arrjson['ruta_gal']);
			$objgal 	= new Galeria();
			$arrjson['sql_gal'] = $objgal->agregar($arrjson);
		}
